...
public class Event {
    ...
    public boolean isEnrollableFor(PrincipalUser userAccount) {
        return isNotClosed() && !isAttended(userAccount) && !isAlreadyEnrolled(userAccount);
    }

    public boolean isDisenrollableFor(PrincipalUser userAccount) {
        return isNotClosed() && !isAttended(userAccount) && isAlreadyEnrolled(userAccount);
    }
    ...
    public boolean isAttended(PrincipalUser userAccount) {
    ...
    private boolean isAlreadyEnrolled(PrincipalUser userAccount) {
        Account account = userAccount.getAccount();
        for (Enrollment e : this.enrollments) {
